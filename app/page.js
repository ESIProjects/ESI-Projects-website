...
export default function Home() {
  ...
  return (
    <main className="min-h-screen w-full overflow-hidden scroll-smooth">
      ...
      <div id="contribute" className=" container m-auto my-28 w-2/3 lg:w-1/2 relative ">
      ...
      <div id="insights" className="container m-auto my-28 w-2/3 relative">
      ...
      <div id="faq" className="container m-auto my-28 w-2/3 relative">
        <div className="monaSans firstColor text-2xl lg:text-3xl font-extrabold underline underline-offset-8 relative bottom-5 w-fit px-5 m-auto rounded-lg">
          <h1>FAQ</h1>
        </div>
